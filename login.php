...
if(isset($_POST['submit']))
{
    ...
    $qu=mysqli_query($con,"select * from user where email='".$name."' AND password='".$password."'")or die(mysqli_error());
    
    $cnt=mysqli_num_rows($qu);
    if($cnt>0)
    {
        $squ=mysqli_query($con,"select * from user where email='$name' AND password='$password' AND status='0'")or die(mysqli_error());
                ...
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        <div class="form-group">
                            <h3 class="fs-22 pb-3 fw-bold">Log in to your account</h3>
                            <div class="divider"><span></span></div>
                            <p class="pt-3">Enter your email address and login to your account.</p>
                        </div>
                        <div class="form-group">
                            <label class="fs-14 text-black fw-medium lh-18">Email</label>
                            <input type="email" name='email' required  class="form-control form--control" placeholder="Email address">
                        </div><!-- end form-group -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button id="send-message-btn" type="submit" name='submit' class="btn theme-btn w-100" type="submit">Log in <i class="la la-arrow-right icon ml-1"></i></button>
                        </div><!-- end form-group -->
